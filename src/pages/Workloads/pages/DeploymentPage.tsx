...
export function DeploymentPage(routeMatch: SceneRouteMatch<any>, parent: SceneAppPageLike) {
    ...
    const deploymentVariable = new ConstantVariable({
        name: 'deployment',
        label: 'deployment',
    ...
    const variables = createTopLevelVariables(jsonData, [namespaceVariable, deploymentVariable]);
